...
The whole project was a lot of fun, doing anything with SVG manipulation is always an interesting challenge.

---

Most of the maps are only accessibly via a paid subscription, but you can try out one of the free [here](https://ee-arts.biz/map/47%e9%83%bd%e9%81%93%e5%ba%9c%e7%9c%8c-2/).  
